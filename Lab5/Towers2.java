...
public class Towers2 {
    ...
    // Recursively moves the discs from the StartingPoint tower to the endingPoint tower.
    public static void tower(int numberOfDiscs, String startingPoint, String endingPoint, 
        ...
        // Recursive case; if there is more than one disc to move, moves the 
        // discs between the rods.
